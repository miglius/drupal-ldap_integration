...
define(LDAP_WRITER_USER_DN, 'cn=admin,dc=pablobm,dc=com');
...
define(LDAP_READER_USER_DN, 'cn=admin,dc=pablobm,dc=com');
define(LDAP_READER_USER_PASS, 'secret');

//   Specifies the relation between LDAP attributes and DrupalDB
// user fields
...
//   Specifies the relation between LDAP groups and Drupal roles,
// as well as which names the latters should take.
$GLOBALS['ldap_group_role_mappings'] = array(
   // LDAP group => Drupal role
   'cn=DeptTST,ou=Departmental,ou=Groups,dc=myorg,dc=mytld' => 'TST',
   'cn=Admins,dc=myorg,dc=mytld' => 'Admin',
   'cn=Admins,dc=pablobm,dc=com' => 'Admin',
   'Clerks' => 'Clerks',
   'simpleSecurityObject' => 'Secured',
   'posixAccount' => 'RMS worshippers'
);
